  ...
  res.json([
    {
      ...
      boards: [
        ...
        },
        {
          ...
          long_description:
            "Uniwersalne deski plasują się między Freestyle Wave i Super Sport.  Oferują świetny początkowy ślizg, komfortową jazdę i fantastyczną prędkość końcową. Są to łatwe i wyrozumiałe deski do halsowania dostarczające ekscytujących, elektryzujących wrażeń przy dużej prędkości; deski windsurfingowe z gatunku plug-and-play — „wskakuj na deskę i baw się”.",
          sizes: [
            {
              volume: 96,
              length: 237,
      ...
      boards: [
        {
          ...
          image: "quad_c.png",
          long_description:
            "Quady są deskami Starboarda — generują maksymalną szybkość i napęd, wnosząc niezwykłą moc i pływalność do Twojego żeglowania. Z nowymi kształtami na rok 2013 Quady radzą sobie na każdej fali i w każdym wietrze.",
          sizes: [
            {
              volume: 70,
              length: 223,
        ...
        },
        {
          ...
          long_description:
            "Deski Kode Wave są szybkimi, sygnowanymi przez Philipa Kostera deskami nowej generacji przeznaczonymi do trików w powietrzu. Deski te dedykowane są surferom, którzy chcą łączyć skoki z potężnymi manewrami na falach. Ich prędkość na prostej i przyspieszenie czynią je najlepszymi do wysokich skoków i podwójnych pętli.",
          sizes: [
            {
              volume: 72,
              length: 223,
        ...
        },
        {
          ...
          image: "flare_c.png",
          long_description:
            "Flare to deski, które łatwo łapią powietrze i natychmiast reagują na ruchy surfera. Szybko przyspieszają i wydają się kompaktowe, a także lekkie zarówno w ślizgach, jak i trickach w powietrzu. Są bardzo lekkie, a mimo to pozostają ekstremalnie wytrzymałe. Ponadto ich projekt ułatwia surferom podejmowanie coraz trudniejszych wyzwań, a jednocześnie są tyle „wyrozumiałe”, by pomóc im wykończyć każdy manewr.",
          sizes: [
            {
              volume: 81,
              length: 227,
