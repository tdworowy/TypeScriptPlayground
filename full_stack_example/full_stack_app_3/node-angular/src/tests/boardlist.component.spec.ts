...
describe("app/tests/boardlist.component.spec.ts", () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: Http,
          useFactory: (instance: MockBackend, options: BaseRequestOptions) => {
            return new Http(instance, options);
          },
  ...
  it("should work with the mocked http provider", async(
  ...
  it("should process a valid JSON respon", async(
    inject([MockBackend], (mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((conn: any) => {
        conn.mockRespond(
          new Response(
  ...
  it("should make a request after clicking the board", async(
    inject([MockBackend], (mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((conn: any) => {
        conn.mockRespond(
          new Response(
      ...
      let boardItem = fixture.debugElement.query(By.css(".board_panel"));
